...
# Dataframe Selection for Train / Test
columns_to_train = ['ID'
              # ,'Age'
              ,'Income'
              # ,'fl_acc_camp_4th'
...
# Variables picked : Income, qt_acc_camp_4h, pct_deal_purchases,qt_purchases (total purchases)
...
# Dataframe Selection for Validation
columns_to_valid = ['ID'
             # ,'Age'
             ,'Income'
            # ,'fl_acc_camp
...
df_profit.to_excel('data/df_profit_2.xlsx',index = False)

# results are interpretated on Excel file df_profit.xlsx
